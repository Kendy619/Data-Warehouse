...
select * from TB_LOJA
select * from TB_LOJA_FUNCIONARIO
...
--CARGAS PARA A ÁREA DE STAGING

CREATE OR ALTER PROCEDURE SP_POVOAR_AUX_PRODUTO
AS
BEGIN
END

CREATE OR ALTER PROCEDURE SP_POVOAR_AUX_LOJA

CREATE OR ALTER PROCEDURE SP_POVOAR_AUX_FUNCIONARIO

CREATE OR ALTER PROCEDURE SP_POVOAR_AUX_VENDA

CREATE OR ALTER PROCEDURE SP_POVOAR_AUX_PAGAMENTO